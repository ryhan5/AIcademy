    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 relative overflow-hidden bg-[var(--bg-dark)]">
            ...
            <div className="fixed inset-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                <div className="absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-[var(--primary)] rounded-full blur-[180px] opacity-20 animate-pulse-slow"></div>
                <div className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[800px] bg-[var(--accent)] rounded-full blur-[180px] opacity-20 animate-pulse-slow delay-1000"></div>
            </div>
